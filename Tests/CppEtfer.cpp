// CppEtfer.cpp : Defines the entry point for the application.
//
...
template<> struct jsonifier::core<Session> {
...
template<> struct jsonifier::core<Data> {
	...
	static constexpr auto parseValue = createObject("session", &ValueType::session, "v", &ValueType::v, "user", &ValueType::user, "shard", &ValueType::shard);
};
...
struct ActivityData {
	...
	operator CppEtfer::etf_serializer() {
		CppEtfer::etf_serializer serializer{};
...
struct UpdatePresenceData {
	...
	operator CppEtfer::etf_serializer() {
		CppEtfer::etf_serializer data{};
		for (auto& value: activities) {
			CppEtfer::etf_serializer newData{};
			if (value.url != "") {
...
int main()
{
	std::vector<uint8_t> stringValues = { 131, 116, 0, 0, 0, 4, 100, 0, 1, 100, 116, 0, 0, 0, 16, 100, 0, 6, 95, 116, 114, 97, 99, 101, 108, 0, 0, 0, 1, 109, 0, 0, 3, 196, 91, 34, 103,
		97, 116, 101, 119, 97, 121, 45, 112, 114, 100, 45, 117, 115, 45, 101, 97, 115, 116, 49, 45, 98, 45, 99, 104, 49, 118, 34, 44, 123, 34, 109, 105, 99, 114, 111, 115, 34, 58,
		49, 56, 51, 50, 51, 52, 44, 34, 99, 97, 108, 108, 115, 34, 58, 91, 34, 105, 100, 95, 99, 114, 101, 97, 116, 101, 100, 34, 44, 123, 34, 109, 105, 99, 114, 111, 115, 34, 58,
		49, 48, 51, 51, 44, 34, 99, 97, 108, 108, 115, 34, 58, 91, 93, 125, 44, 34, 115, 101, 115, 115, 105, 111, 110, 95, 108, 111, 111, 107, 117, 112, 95, 116, 105, 109, 101, 34,
		44, 123, 34, 109, 105, 99, 114, 111, 115, 34, 58, 51, 53, 55, 44, 34, 99, 97, 108, 108, 115, 34, 58, 91, 93, 125, 44, 34, 115, 101, 115, 115, 105, 111, 110, 95, 108, 111,
		111, 107, 117, 112, 95, 102, 105, 110, 105, 115, 104, 101, 100, 34, 44, 123, 34, 109, 105, 99, 114, 111, 115, 34, 58, 49, 54, 44, 34, 99, 97, 108, 108, 115, 34, 58, 91, 93,
		125, 44, 34, 100, 105, 115, 99, 111, 114, 100, 45, 115, 101, 115, 115, 105, 111, 110, 115, 45, 112, 114, 100, 45, 50, 45, 50, 53, 34, 44, 123, 34, 109, 105, 99, 114, 111,
		115, 34, 58, 49, 55, 57, 56, 56, 51, 44, 34, 99, 97, 108, 108, 115, 34, 58, 91, 34, 115, 116, 97, 114, 116, 95, 115, 101, 115, 115, 105, 111, 110, 34, 44, 123, 34, 109,
		105, 99, 114, 111, 115, 34, 58, 56, 54, 57, 52, 54, 44, 34, 99, 97, 108, 108, 115, 34, 58, 91, 34, 100, 105, 115, 99, 111, 114, 100, 45, 97, 112, 105, 45, 53, 100, 99, 100,
		102, 55, 98, 99, 52, 56, 45, 114, 102, 103, 50, 115, 34, 44, 123, 34, 109, 105, 99, 114, 111, 115, 34, 58, 55, 57, 57, 57, 55, 44, 34, 99, 97, 108, 108, 115, 34, 58, 91,
		34, 103, 101, 116, 95, 117, 115, 101, 114, 34, 44, 123, 34, 109, 105, 99, 114, 111, 115, 34, 58, 50, 49, 51, 54, 57, 125, 44, 34, 103, 101, 116, 95, 103, 117, 105, 108,
		100, 115, 34, 44, 123, 34, 109, 105, 99, 114, 111, 115, 34, 58, 56, 52, 56, 49, 125, 44, 34, 115, 101, 110, 100, 95, 115, 99, 104, 101, 100, 117, 108, 101, 100, 95, 100,
		101, 108, 101, 116, 105, 111, 110, 95, 109, 101, 115, 115, 97, 103, 101, 34, 44, 123, 34, 109, 105, 99, 114, 111, 115, 34, 58, 49, 53, 125, 44, 34, 103, 117, 105, 108, 100,
		95, 106, 111, 105, 110, 95, 114, 101, 113, 117, 101, 115, 116, 115, 34, 44, 123, 34, 109, 105, 99, 114, 111, 115, 34, 58, 57, 49, 49, 125, 44, 34, 97, 117, 116, 104, 111,
		114, 105, 122, 101, 100, 95, 105, 112, 95, 99, 111, 114, 111, 34, 44, 123, 34, 109, 105, 99, 114, 111, 115, 34, 58, 49, 53, 125, 93, 125, 93, 125, 44, 34, 115, 116, 97,
		114, 116, 105, 110, 103, 95, 103, 117, 105, 108, 100, 95, 99, 111, 110, 110, 101, 99, 116, 34, 44, 123, 34, 109, 105, 99, 114, 111, 115, 34, 58, 50, 51, 56, 44, 34, 99, 97,
		108, 108, 115, 34, 58, 91, 93, 125, 44, 34, 112, 114, 101, 115, 101, 110, 99, 101, 95, 115, 116, 97, 114, 116, 101, 100, 34, 44, 123, 34, 109, 105, 99, 114, 111, 115, 34,
		58, 52, 52, 54, 57, 50, 44, 34, 99, 97, 108, 108, 115, 34, 58, 91, 93, 125, 44, 34, 103, 117, 105, 108, 100, 115, 95, 115, 116, 97, 114, 116, 101, 100, 34, 44, 123, 34,
	...
	activityData.type = ActivityType::Game;
	...
	auto newString = updatePresenceData.operator CppEtfer::etf_serializer().operator std::basic_string<uint8_t>();
		
	std::cout << "Etf data: " << newString.data() << std::endl;

	CppEtfer::etf_parser parser{};
	auto newData = parser.parseEtfToJson(presenceUpdateString);
	std::cout << "Json data: " << newData << std::endl;

	CppEtfer::etf_parser parser02{};
	auto newData02 = parser02.parseEtfToJson(newString);

	std::cout << "Json data: " << newData02 << std::endl;
	return 0;
}
